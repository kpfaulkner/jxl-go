...
var (
	...
	dct4x4params = util.New2DMatrixWithContents[float64](3, 4, [][]float64{
		{2200, 0.0, 0.0, 0.0},
		{392, 0.0, 0.0, 0.0},
		{112, -0.25, -0.25, -0.5}})

	dct4x8params = util.New2DMatrixWithContents[float64](3, 4, [][]float64{
...
func setupDefaultParams() {
	...
	defaultParams[0] = DCTParam{
		...
		dctParam: util.New2DMatrixWithContents[float64](3, 6,
			[][]float64{{3150.0, 0.0, -0.4, -0.4, -0.4, -2.0},
				{560.0, 0.0, -0.3, -0.3, -0.3, -0.3},
				{512.0, -2.0, -1.0, 0.0, -1.0, -2.0}}),
		param:       nil,
		mode:        MODE_DCT,
	...
	defaultParams[9] = DCTParam{
		...
		param: util.New2DMatrixWithContents[float32](3, 1,
			[][]float32{{1.0}, {1.0}, {1.0}}),
		mode:        MODE_DCT4_8,
		denominator: 1,
		params4x4:   nil,
	...
	defaultParams[10] = DCTParam{
		dctParam: dct4x8params,
		param: util.New2DMatrixWithContents[float32](3, 9,
			[][]float32{
