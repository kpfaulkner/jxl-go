...
type SymbolDistribution interface {
	ReadSymbol(reader *jxlio.BitStreamReader, state *ANSState) (int32, error)
...
func (rcvr *SymbolDistributionBase) ReadSymbol(reader *jxlio.BitStreamReader, state *ANSState) (int32, error) {
